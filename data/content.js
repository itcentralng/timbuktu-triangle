...
const TT_CONTENT = {
  ...
  ui: {
    en: {
      ...
      menuTeam: 'Committee',
      menuTeamSub: 'Behind the memorial project',
      back: 'Back',
      home: 'Home',
      listen: 'Listen',
      pause: 'Pause',
      ...
      howMuchTimeSub: 'Select a duration according to your available time',
      minutes: 'minutes',
      minuteAbbr: 'min',
      watchNow: 'Watch',
      ...
      teamIntro: 'The Nigerian Army’s committee behind the Timbuktu Triangle memorial project.',
    ...
    fr: {
      ...
      menuTeam: 'Comité',
      menuTeamSub: 'À l’origine du projet commémoratif',
      back: 'Retour',
      home: 'Accueil',
      listen: 'Écouter',
      pause: 'Pause',
      ...
      teamIntro: "Le comité de l'Armée nigériane à l'origine du projet commémoratif du Triangle de Timbuktu.",
    ...
    ar: {
      ...
      menuTeam: 'اللجنة',
      menuTeamSub: 'وراء مشروع النصب التذكاري',
      back: 'رجوع',
      home: 'الرئيسية',
      listen: 'استماع',
      pause: 'إيقاف',
      ...
      operationIVDate: 'يناير ٢٠٢٥',
      operationV: 'عملية ديزرت سانيتي الخامسة',
      operationVDate: 'يناير ٢٠٢٦',
      newsFilterAll: 'الكل',
      ...
      teamIntro: 'لجنة الجيش النيجيري وراء مشروع النصب التذكاري لمثلث تمبكتو.',
      tributeIV: 'الشهداء — ٢٤ يناير ٢٠٢٥',
      tributeV: 'الشهداء — ٢٠ يناير ٢٠٢٦',
      rank: 'الرتبة',
      name: 'الاسم',
      unit: 'الوحدة',
      remarks: 'ملاحظات',
  ...
  about: {
    ...
    ar: {
      ...
      paragraphs: [
        ...
        "تحمل السيطرة على مثلث تمبكتو أهمية عملياتية ونفسية في آنٍ واحد، إذ تعكس الهيمنة في مسرح عمليات شمال شرق نيجيريا، وتحرم المتمردين من قاعدة دعم ودعاية حيوية، وبذلك تعزز الثقة لدى السكان المحليين وقوات الأمن. وبناءً على ذلك، فإن التحييد الفعّال للمنطقة يتطلب عمليات برية وجوية متواصلة ومتكاملة، وإنشاء قواعد عمليات أمامية والحفاظ عليها، ودوريات مستمرة وتغطية استخباراتية ومراقبة واستطلاع، وتعزيزًا للتعاون المدني العسكري لتفكيك شبكات دعم المتمردين. وفي عام ٢٠٢٥ نفذت قوات عملية ديزرت سانيتي الرابعة هجومًا مقصودًا داخل المثلث. إذ تقدمت القوات المشتركة من الكتيبة CT ٦/٨ والكتيبة ١٩٩ للقوات الخاصة التابعة لقيادة العمليات على محور دامبوا–كافا داخل المثلث، وطهّرت عدة جيوب إرهابية، ثم شغلت لاحقًا موقع مرابطة مؤقتًا انطلقت منه العمليات إلى عمق المثلث. غير أنه في ٢٤ يناير ٢٠٢٥، تعرضت القوات لهجوم في موقع المرابطة بواسطة عبوة ناسفة مفخخة محمولة على مركبة (VBIED)، وأسفر الانفجار عن شظايا متعددة أصابت وقتلت قائد الكتيبة ١٩ (الرئيسية)، وضابطَين آخرَين، ٢٢ جنديًا، و٦ من أفراد قوة العمل المشتركة المدنية (CJTF)، بينما أُصيب ضابطان ٢٥ جنديًا بإصابات متفاوتة الشدة. وقد دفعت هذه النكسة قائد مسرح العمليات إلى وقف استمرار العملية نظرًا للمسافة بين موقع المرابطة والقاعدة الرئيسية في دامبوا، وصعوبة التضاريس التي جعلت إجلاء القتلى والجرحى لتلقي الرعاية الطبية أمرًا صعبًا.",
        "وبالمثل، في عام ٢٠٢٦ بدأت قوات فرقة التدخل التابعة لقيادة القوات (AHQ)، المعروفة باسم مجموعة القتال مايك (BG MIKE)، ضمن عملية ديزرت سانيتي الخامسة، هجومًا لتطهير مثلث تمبكتو في يناير ٢٠٢٦. وتمكنت القوات من تطهير معاقل إرهابية رئيسية، وتحييد عدد من الإرهابيين، واستعادة كميات متنوعة من الأسلحة والذخائر. وبسبب امتداد خطوط الاتصال، شغلت القوات موقع مرابطة في غارديري وكانت تُزوَّد بالإمدادات عن طريق الإنزال الجوي. وأثناء تواجدها في موقع المرابطة، تعرضت مجموعة BG MIKE لهجوم من بوكو حرام باستخدام عبوتين ناسفتين مفخختين محمولتين على مركبة (VBIED) في ٢٠ يناير ٢٠٢٦. وقاتلت القوات ببسالة، وتمكنت من تحييد عدد من المهاجمين وتدمير إحدى العبوتين الناسفتين، بينما انفجرت العبوة الأخرى وسط صفوف القوات. ونتيجة لذلك الانفجار، استُشهد ٩ جنود و٣ من أفراد قوة العمل المشتركة المدنية (CJTF)، بينما أُصيب ضابطان ٣٢ جنديًا. غير أنه، وخلافًا لما حدث في عام ٢٠٢٥ فقد نشر طيران الجيش النيجيري (NA AVN)، الذي دخل الخدمة الفعلية في عام ٢٠٢٣ طائراته المروحية (هوكآي ١ وهوكآي ٢) لإجلاء القتلى والجرحى إلى الخدمات الطبية ومستشفى الفرقة السابعة.",
